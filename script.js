...
window.alert("This program meets the requierements of doing a POST through saving " +
            "favorites (getpantry.cloud).");

window.alert("Click on a state to do a database search.  Click on the hearts to like " +
...
window.alert("Note 1: The JSON database of pets/users was pre-generated by myself " +
            "and is hosted on jsonsilo.com.\n\n" +
